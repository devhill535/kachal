...
async run(message,bot) {
  ...
  *\if (data4 && data4.log === "enable") return;
  ...
  if (!command.enabled) return await message.channel.send(new Discord.MessageEmbed().setColor("#37383b").setAuthor("The Av Development", "https://media.discordapp.net/attachments/829446297115033610/831559964165406771/image0.gif").setDescription(`This command is **Disable** for now`));
  ...
  if (command.guilOwnerOnly) {
      ...
      ) return message.channel.send(new Discord.MessageEmbed().setColor("#37383b").setAuthor("The Av Development", "https://media.discordapp.net/attachments/829446297115033610/831559964165406771/image0.gif").setDescription(`This command is only for guildOwner`));
	  }
  let neededPermissions = [];
	 ...
	 if(neededPermissions.length > 0){
	  ...
	  if(neededPermissions.length > 0){
		  return message.channel.send(new Discord.MessageEmbed().setAuthor("The Av Development", "https://media.discordapp.net/attachments/829446297115033610/831559964165406771/image0.gif").setColor("#37383b").setDescription(`You don't have a ${neededPermissions.map((p) => `\`${p}\``).join(", ")} permissions`));
	 }
