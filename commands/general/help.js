...
module.exports = {
  ...
  let help = new Discord.MessageEmbed()
    ...
    .setAuthor(Author)
    .setImage(Image)
    .setDescription(`<@${bot.user.id}> a security bot to protection your server please use **s!help** followed by a command name to get more additional information on a command. For example: **s!help ping**\n\n`[**Prefix Information**]\nPrefix: **s!**\nYou can also mention <@${bot.user.id}> to get prefix info`)
