  ...
  run: async (bot, message, args) => {
    ...
    if (args[1] === "on") {
      ...
      const embed = new Discord.MessageEmbed()
        .setColor(Color)
        .setDescription(`<a:true:854842599444709386> The **AntiBan** system is enabled correctly!`);
      ...
      const embed1 = new Discord.MessageEmbed()
        .setColor(Color)
        .setDescription(`<a:false:854842600351334440> The **Antiban** system is disabled correctly!`);
